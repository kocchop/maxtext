...
def shard_reorder_causal_load_balanced(batch, cp_size, shard_mode, reorder_strategy):
...
def get_reorder_callable(cp_size, shard_mode, reorder_strategy=0): # 0=DualChunkSwap, 1=Striped
  ...
  return functools.partial(shard_reorder_causal_load_balanced, cp_size=cp_size, shard_mode=shard_mode, reorder_strategy=reorder_strategy)
