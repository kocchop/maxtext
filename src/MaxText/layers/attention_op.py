...
class AttentionOp(nnx.Module):
  ...
  def cudnn_flash_attention(
    ...
    using_ring_cp = using_context_parallelism and self.config.context_parallel_strategy == "ring"
    ...
    if self.config.packing:
      if using_context_parallelism and not using_ring_cp:
        raise AssertionError("Packing is only supported for ring context parallelism.")
      ...
      print(f"Using default case: no packing, no context parallelism")
